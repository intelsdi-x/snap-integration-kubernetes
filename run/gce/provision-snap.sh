...
function install_gcloud {
        ...
        wget -q https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-sdk-138.0.0-linux-x86_64.tar.gz -O gcloud-sdk-138.tar.gz
        echo "===> UNPACKING tar ball"
        tar -xf gcloud-sdk-138.tar.gz -C $HOME && rm gcloud-sdk-138.tar.gz
...
function build_snap_image {
        ...
        echo "===> TAG snap image"
        sg docker -c "docker tag -f snap gcr.io/$1/snap "
...
function build_grafana_image {
        ...
        sg docker -c "docker tag -f grafana-snap gcr.io/$1/grafana-snap"
